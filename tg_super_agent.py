...
if not all([SESSION_STRING, API_ID, API_HASH, XAI_KEY]):
    logging.error("ОШИБКА: Не все переменные окружения заданы! Проверь Variables в Railway.")
    raise ValueError("Отсутствуют обязательные переменные")
